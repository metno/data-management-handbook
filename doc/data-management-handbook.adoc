...
:numbered:
include::specialized_intro_template.adoc[]

:numbered:
include::structure_and_documenting.adoc[]

:numbered:
include::specialized_strudoc_template.adoc[]

:numbered:
include::data_services.adoc[]

:numbered:
include::specialized_data_services_template.adoc[]

:numbered:
include::user_portals.adoc[]

:numbered:
include::specialized_userportals_template.adoc[]

:numbered:
include::data_governance.adoc[]

:numbered:
include::specialized_datagov_template.adoc[]
