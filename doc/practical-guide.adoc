...
1. Log in to link:https://easydmp.sigma2.no/login/[easyDMP], use *Dataporten* if your institution supports that, otherwise pick one of the other login methods.
1. Click on *+ Create a new plan* and pick a template
1. By using the *Summary* button from page two and on, you can get an overview of all the questions.
