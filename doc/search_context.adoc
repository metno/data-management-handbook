...
Pycsw only supports geographical searches querying for a box. For more advanced geographical searches, one must write his own XML files. For example:

* to find all datasets that contains a point
...
* to find all datasets that intersects a polygon
