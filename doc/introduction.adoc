...
* *Integrity* – ensuring that data and data access can be maintained over time, and ensuring that the user receives the same data at any time of request;
