...
please try to use the nc2mmd script locally in order to understand what is
wrong.

The OpenAPI documentation for the API can be found at py-mmd-tools.s-enda.k8s.met.no/docs
