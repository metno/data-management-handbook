...
Shows the datasets containing `arctic` keyword in the title and in a given date:
...
Shows the datasets having a given `metadata_identifier`:
...
Shows the datasets containing `direct` keyword in the title and within a given time span:
