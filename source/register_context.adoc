...
`MMD-Agent` is subscribing to all these messages coming through the event queue. If the messsage contains a MMD payload, it will post the MMD file to `DMCI`.
