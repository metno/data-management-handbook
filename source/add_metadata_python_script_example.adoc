...
$ nc2mmd -u https://thredds.met.no/thredds/dodsC/metusers/magnusu/test-2023-02-03/meps_reduced.nc -i <path-to-data-management-handbook>/example_scripts/meps_reduced.nc -o .
